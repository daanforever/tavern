...
#queue:            bundle exec bin/delayed_job run
...
queue-every1min: bundle exec bin/delayed_job --queue=every1min run
#queue-instances:  bundle exec bin/delayed_job --queue=instances run
